...
import {
  ...
  Wallet, HandCoins, Gift, ShieldCheck, Eye, Trash2, Edit3, Check,
...
const SOURCES = {
  "breslev.fr": "Keren Rabbi Israël France (breslev.fr)",
...
const SEED_PRODUCTS = [
  ...
  { titre: "'Hok Breslev - Otsrot Rabbi Na'hman (coffret)", langue: "AUTRE", source: "aech-cheli.com", prixCoutant: 85, devise: "EUR", photo: "" },
  ...
  { titre: "Set 'Houmachim - Likouté Halakhot sur la Paracha", langue: "AUTRE", source: "aech-cheli.com", prixCoutant: 75, devise: "EUR", photo: "" },
  ...
  // --- breslever.com (traductions françaises, prix à compléter — non affichés publiquement) ---
  { titre: "Des Mots qui Guérissent", langue: "FR", source: "breslever.com", prixCoutant: 0, devise: "EUR", photo: "https://breslever.com/wp-content/uploads/2024/12/LIVRE-DES-MOTS-QUI-GUERISSENT-MD.png" },
  { titre: "Vers la Terre Sainte", langue: "FR", source: "breslever.com", prixCoutant: 0, devise: "EUR", photo: "https://breslever.com/wp-content/uploads/2023/11/vers-la-terre-sainte-face-150-crop-u297325_2x.png" },
  { titre: "L'Alphabet Lumineux", langue: "FR", source: "breslever.com", prixCoutant: 0, devise: "EUR", photo: "https://breslever.com/wp-content/uploads/2023/11/alphabet-lumineux-face-150c_2x.png" },
  { titre: "Les Ailes du Cœur", langue: "FR", source: "breslever.com", prixCoutant: 0, devise: "EUR", photo: "https://breslever.com/wp-content/uploads/2023/11/les-ailes-face-150-u111643_2x.png" },
  { titre: "Le Solfège de l'Âme & Régénération", langue: "FR", source: "breslever.com", prixCoutant: 0, devise: "EUR", photo: "https://breslever.com/wp-content/uploads/2024/12/LIVRE-SOLFEGE-DE-LAME-MD.png" },
  { titre: "Contes & Merveilles", langue: "FR", source: "breslever.com", prixCoutant: 0, devise: "EUR", photo: "https://breslever.com/wp-content/uploads/2023/11/contes-face-150-u111592_2x.png" },
  { titre: "Lettre à un Ami", langue: "FR", source: "breslever.com", prixCoutant: 0, devise: "EUR", photo: "https://breslever.com/wp-content/uploads/2023/11/letrres-a-un-ami-face-150-u297356_2x.png" },
  { titre: "Les Conseils", langue: "FR", source: "breslever.com", prixCoutant: 0, devise: "EUR", photo: "https://breslever.com/wp-content/uploads/2025/09/CONSEILS-attente-2025.png" },
  { titre: "Les Chemins de Lumière", langue: "FR", source: "breslever.com", prixCoutant: 0, devise: "EUR", photo: "https://breslever.com/wp-content/uploads/2025/11/LIVRE-LES-CHEMINS.png" },
  { titre: "Les Sources du Salut", langue: "FR", source: "breslever.com", prixCoutant: 0, devise: "EUR", photo: "https://breslever.com/wp-content/uploads/2023/11/les-sources-du-saluts-face-150-crop-u297365_2x.png" },
  { titre: "Le Tikoune Haklali", langue: "FR", source: "breslever.com", prixCoutant: 0, devise: "EUR", photo: "https://breslever.com/wp-content/uploads/2023/11/tikoune-face-125_2x.png" },
  { titre: "Le Tikoune Haklali et Réparation de Minuit", langue: "FR", source: "breslever.com", prixCoutant: 0, devise: "EUR", photo: "https://breslever.com/wp-content/uploads/2024/12/LIVRE-TIKOUNE-HAKLALI-HATSOTH.png" },
  { titre: "Les Noms des Justes", langue: "FR", source: "breslever.com", prixCoutant: 0, devise: "EUR", photo: "https://breslever.com/wp-content/uploads/2024/12/LIVRE-SERIE-MOU-FACE-MD.png" },
  ...
  { titre: "Coffret Essentiel (7 œuvres)", langue: "FR", source: "breslever.com", prixCoutant: 0, devise: "EUR", photo: "https://breslever.com/wp-content/uploads/2026/03/LIVRE-COFFRET-ESSENTIEL-BD.jpg" },
  { titre: "Coffret Collection Breslev (11 livres)", langue: "FR", source: "breslever.com", prixCoutant: 0, devise: "EUR", photo: "https://breslever.com/wp-content/uploads/2026/03/LIVRE-GRAND-COFFRET-BD.jpg" },
  { titre: "L'Arbre de Vie", langue: "FR", source: "breslever.com", prixCoutant: 0, devise: "EUR", photo: "https://breslever.com/wp-content/uploads/2026/03/LIVRE-ABRE-DE-VIE-BD.jpg" },
  { titre: "Vive la Vie !", langue: "FR", source: "breslever.com", prixCoutant: 0, devise: "EUR", photo: "https://breslever.com/wp-content/uploads/2026/03/LIVRE-VIVE-LA-VIE-BD.jpg" },
  { titre: "En Chemin - Vers l'Éveil", langue: "FR", source: "breslever.com", prixCoutant: 0, devise: "EUR", photo: "https://breslever.com/wp-content/uploads/2026/03/LIVRE-EN-CHEMIN-BD.jpg" },
  { titre: "Courage ! / Renouveau / Bonheur & Joie - Tome 1", langue: "FR", source: "breslever.com", prixCoutant: 0, devise: "EUR", photo: "https://breslever.com/wp-content/uploads/2026/03/LIVRE-TOME-I-BD.jpg" },
  { titre: "La Porte du Ciel / Il est Temps de Chanter / Le Chant Nouveau - Tome 2", langue: "FR", source: "breslever.com", prixCoutant: 0, devise: "EUR", photo: "https://breslever.com/wp-content/uploads/2026/03/LIVRE-TOME-II-BD.jpg" },
  { titre: "La Porte du Ciel - Hitbodédouth", langue: "FR", source: "breslever.com", prixCoutant: 0, devise: "EUR", photo: "https://breslever.com/wp-content/uploads/2026/03/LIVRE-MINI-LA-PORTE-DU-CIEL-BD.jpg" },
  { titre: "Courage ! - Le désespoir n'existe pas", langue: "FR", source: "breslever.com", prixCoutant: 0, devise: "EUR", photo: "https://breslever.com/wp-content/uploads/2026/03/LIVRE-MINI-COURAGE-BD.jpg" },
  { titre: "Bonheur & Joie - Dans la Torah", langue: "FR", source: "breslever.com", prixCoutant: 0, devise: "EUR", photo: "https://breslever.com/wp-content/uploads/2026/03/LIVRE-MINI-BONHEUR-BD.jpg" },
  { titre: "Ouman", langue: "FR", source: "breslever.com", prixCoutant: 0, devise: "EUR", photo: "https://breslever.com/wp-content/uploads/2026/03/LIVRE-MINI-OUMAN-BD.jpg" },
  { titre: "Il est Temps de Chanter (sur les Psaumes)", langue: "FR", source: "breslever.com", prixCoutant: 0, devise: "EUR", photo: "https://breslever.com/wp-content/uploads/2026/03/LIVRE-MINI-IL-EST-TEMPS-BD.jpg" },
];
      ...
      messages: [
        {
          ...
          content: [
            { type: "image", source: { type: "base64", media_type: mediaType, data: base64 } },
            {
              type: "text",
              text:
                "Cette image est une capture d'écran d'une page produit d'un site vendant des livres de Rabbi Nahman de Breslev (ex: breslever.fr, haesh-cheli.com, haesh-sheli.co.il, malevegadish.com, tikoun-aolam.com). " +
...
export default function HafatzaApp() {
  ...
  const [receptionPreselect, setReceptionPreselect] = useState(null);
    ...
    <div className="min-h-screen bg-slate-50 text-slate-800" style={{ fontFamily: "Inter, system-ui, sans-serif" }}>
      ...
      <div className="max-w-6xl mx-auto px-4 py-6">
        ...
        {tab === "reception" && isAdmin && (
          <ReceptionTab data={data} patch={patch} preselectId={receptionPreselect} stockCounts={stockCounts} />
        )}
        ...
        {tab === "catalogue" && (
          <CatalogueTab
            ...
            onAddToStock={
              isAdmin
                ? (productId) => {
                    setReceptionPreselect(productId);
                    setTab("reception");
                  }
                : undefined
            }
...
============================================================ */
function ReceptionTab({ data, patch, preselectId, stockCounts }) {
  const [productId, setProductId] = useState(preselectId || "");
  const [origine, setOrigine] = useState("personnel");
  const [fournisseurId, setFournisseurId] = useState("");
  const [qte, setQte] = useState(1);
  const [prixAchat, setPrixAchat] = useState("");
  const [modePaiement, setModePaiement] = useState("espece");
  const [sourcePaiement, setSourcePaiement] = useState("caisse"); // caisse | personnel_avance
  ...
  const submit = () => {
    if (!productId) { setMsg("Choisis un livre du catalogue."); return; }
    if (origine === "depot" && !fournisseurId) { setMsg("Choisis un fournisseur pour un dépôt-vente."); return; }
    ...
    patch((d) => {
      for (let i = 0; i < n; i++) {
        d.stock.push({
          ...
          productId,
          origine,
          fournisseurId: origine === "depot" ? fournisseurId : null,
          prixAchat: prix,
          modePaiementAchat: origine === "depot" ? null : modePaiement,
          dateAcquisition: date,
          statut: "stock",
        });
      }
      if ((origine === "personnel" || origine === "maasser") && prix > 0) {
        if (sourcePaiement === "personnel_avance" && origine === "personnel") {
          d.movements.push({
            id: uid(),
            date,
            type: "achat",
            ...
            caisseDelta: 0,
            maasserDelta: 0,
            personnelDelta: prix * n,
            note: `Avance personnelle — ${PAIEMENTS[modePaiement]}`,
          });
        } else if (sourcePaiement === "caisse") {
          d.movements.push({
            id: uid(),
            date,
            type: "achat",
            label: `Achat: ${n} × ${product?.titre || ""} (${ORIGINES[origine].label})`,
            caisseDelta: -(prix * n),
            maasserDelta: 0,
            note: `Payé via caisse — ${PAIEMENTS[modePaiement]}`,
          });
        }
      }
      return d;
    });
    setMsg("Ajouté au stock ✔");
    setQte(1); setPrixAchat("");
    setTimeout(() => setMsg(""), 2000);
  };

  return (
    <div className="max-w-lg space-y-3">
      <h2 className="font-semibold text-slate-700 mb-1">Nouvelle réception de stock</h2>
      <BookPickerField label="Livre" products={data.products} value={productId} onChange={setProductId} stockCounts={stockCounts} />
      <p className="text-[11px] text-slate-400 -mt-2">Pas encore dans le catalogue ? Ajoute-le d'abord dans l'onglet Catalogue.</p>

      <Field label="Origine financière">
        <div className="grid grid-cols-2 gap-2">
          {Object.entries(ORIGINES).map(([k, v]) => (
            <button
              ...
              className={`text-xs font-medium rounded-lg px-3 py-2 border text-left ${origine === k ? "ring-2 ring-offset-1" : ""}`}
              style={{ borderColor: v.color, background: v.bg, color: v.color, ...(origine === k ? { boxShadow: `0 0 0 2px ${v.color}` } : {}) }}
            >
              {v.label}
            </button>
          ))}
      ...
      {origine === "depot" && (
        <Field label="Fournisseur (dépôt-vente)">
          <select className={inputCls} value={fournisseurId} onChange={(e) => setFournisseurId(e.target.value)}>
            <option value="">— Choisir —</option>
            {data.fournisseurs.map((f) => <option key={f.id} value={f.id}>{f.nom}</option>)}
          </select>
          {data.fournisseurs.length === 0 && <span className="text-[11px] text-amber-600">Ajoute d'abord un fournisseur dans l'onglet dédié.</span>}
        </Field>
      )}

      <div className="grid grid-cols-2 gap-3">
        <Field label="Quantité">
          <input type="number" min="1" className={inputCls} value={qte} onChange={(e) => setQte(e.target.value)} />
        </Field>
        <Field label={origine === "depot" ? "Prix dû au fournisseur si vendu (₪)" : "Prix d'achat unitaire (₪)"}>
          <input type="number" className={inputCls} value={prixAchat} onChange={(e) => setPrixAchat(e.target.value)} />
        </Field>
      </div>
        ...
        <>
          ...
          {origine === "personnel" ? (
            <Field label="Qui a payé ?">
              <div className="grid grid-cols-2 gap-2">
                <button type="button" onClick={() => setSourcePaiement("caisse")} className={`text-xs font-medium rounded-lg px-3 py-2 border ${sourcePaiement === "caisse" ? "bg-indigo-600 text-white border-indigo-600" : "border-slate-300 text-slate-600"}`}>
                  La caisse Hafatza
                </button>
                <button type="button" onClick={() => setSourcePaiement("personnel_avance")} className={`text-xs font-medium rounded-lg px-3 py-2 border ${sourcePaiement === "personnel_avance" ? "bg-amber-500 text-white border-amber-500" : "border-slate-300 text-slate-600"}`}>
                  Toi, de ta poche (à te rembourser)
                </button>
              </div>
              <span className="text-[11px] text-slate-400">Si tu avances l'argent, ça sera suivi comme une dette envers toi jusqu'à ce qu'une vente te rembourse.</span>
            </Field>
          ) : (
            <label className="flex items-center gap-2 text-sm text-slate-600 mb-2">
              <input type="checkbox" checked={sourcePaiement === "caisse"} onChange={(e) => setSourcePaiement(e.target.checked ? "caisse" : "aucun")} />
              Cet achat a été payé depuis la caisse Hafatza (décompte la caisse)
            </label>
          )}
        </>
      )}
      ...
      <Btn onClick={submit}><Plus size={15} /> Ajouter au stock</Btn>
    </div>
  );
}
  ...
  return (
    <div className="space-y-4">
      <div className="flex justify-between items-center">
        ...
        <Btn onClick={() => setAddOpen(true)}><Plus size={15} /> Ajouter</Btn>
      </div>
      ...
      <Modal open={addOpen} onClose={() => setAddOpen(false)} title="Nouveau fournisseur">
        ...
        <div className="flex justify-end gap-2">
          ...
          <Btn onClick={() => {
            if (!nom) return;
            patch((d) => { d.fournisseurs.push({ id: uid(), nom, contact }); return d; });
            setNom(""); setContact(""); setAddOpen(false);
          }}>Ajouter</Btn>
        </div>
      </Modal>
    </div>
    ...
    <div className="space-y-4">
      ...
      <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-4">
        ...
        {filtered.map((p) => {
          ...
          return (
            <div key={p.id} className="bg-white rounded-2xl border border-slate-200 overflow-hidden group hover:shadow-md transition-shadow flex flex-col">
              <div className="aspect-[3/4] bg-slate-100 flex items-center justify-center overflow-hidden">
                {p.photo ? (
              ...
              <div className="p-3 flex-1 flex flex-col">
                ...
                {isAdmin && (onAddToStock || onDistribute) && (
      ...
      {isAdmin && <ProductFormModal open={addOpen} onClose={() => setAddOpen(false)} patch={patch} />}
      {isAdmin && editing && <ProductFormModal open={!!editing} onClose={() => setEditing(null)} patch={patch} product={editing} />}
    </div>
  );
}

function ProductFormModal({ open, onClose, patch, product }) {
